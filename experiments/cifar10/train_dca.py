...
from utils import DCAMODELS, TRAINDATALOADERS, OUTCLASS, coro_trackbestloss, \
    savecheckpoint, loadcheckpoint, NTRAIN
...
if __name__ == '__main__':
    ...
    if args.resume:
        ...
        dcamodel = DCAMODELS[args.arch](
            OUTCLASS[args.dataset], args.dcacopies).to(args.device)
        modelargs, modelkwargs = (OUTCLASS[args.dataset], args.dcacopies), {}
