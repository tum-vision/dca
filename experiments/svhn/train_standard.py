...
from utils import STANDARDMODELS, MCDROPMODELS, coro_trackbestloss, \
...
if __name__ == '__main__':
    ...
    if args.resume:
        ...
        startepoch = 0
        model = MODELS[args.arch](SVHNInfo.outclass).to(args.device)
        modelargs, modelkwargs = (SVHNInfo.outclass,), {}
